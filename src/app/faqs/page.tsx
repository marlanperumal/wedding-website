        ...
        <dl className="space-y-10">
          <Faq question="Why are there so many events?">
            <p>
              ...
              ceremonies and celebrations, and different communities have
              different names and customs for each. We&rsquo;re keeping it light
              actually, with just 2 days! On the day before (Thursday) the bride
              and groom will be having separate blessing ceremonies in the
              morning: the Mehndi and Nelengu respectively. The night before is
              generally a big party filled with music and dancing called a
              Sangeet. Ours will be a simple, informal gathering at our home,
              where we invite you to pop in, have a bite and a glass, and
              generally just hang out with us before the formal stuff the next
              day &mdash; the actual wedding and reception. The Thursday events
              are all completely optional, but we&rsquo;d love to have you share
              in them with us. For more details on exactly what will be
              happening, when and where, see the{" "}
          ...
          <Faq question="What is the dress code for each event?">
            <EventLine label="Mehndi / Nelengu">
              Bright, festive colours (yellows / oranges). Casual or
              semi-formal. Eastern if you prefer.
            </EventLine>
            <EventLine label="Sangeet">
              It&rsquo;s an informal gathering, so please feel free to wear
              whatever you&rsquo;re most comfortable in.
            </EventLine>
            <EventLine label="Wedding Ceremony">
              Please wear traditional Indian attire (e.g. saris, lehengas,
              kurtas &mdash; see the <FaqLink href="/attire">Attire page</FaqLink>{" "}
              for full details). We encourage
              bright, festive colours. Please avoid wearing pure white
              (that&rsquo;s for funerals), red and gold (that&rsquo;s what the
              bride will be wearing) and jeans (I made Marlan add this in).
            </EventLine>
          </Faq>
          ...
          <Faq question="What time should I arrive?">
            ...
            <EventLine label="Wedding Ceremony">
              ...
              allow time for parking, seating, and to ensure the ceremony starts
              on time.
            </EventLine>
          </Faq>
          ...
          <Faq question="Can I bring a plus one or additional guests?">
            ...
            <p className="mt-3">
              We love your little ones! However, unless specifically named on
              your invitation, please arrange a sitter.
            </p>
          </Faq>
          ...
          <Faq question="Is accommodation available nearby?">
            <p>
              ...
              <FaqLink href="/accommodation">Accommodation page</FaqLink>.
...
function Faq({
  ...
  return (
    <div>
      <dt className="font-serif text-xl italic text-purple-deep mb-2">
        {question}
      </dt>
      <dd className="font-sans text-sm text-near-black/75 leading-relaxed">
        {children}
      </dd>
    </div>
  );
